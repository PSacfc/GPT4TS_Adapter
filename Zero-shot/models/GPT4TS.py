...
class SpectBlock(nn.Module):
    def __init__(self, in_feat, freq_len, low_rank=8, adapter_len=2):
        super().__init__()
...
class GPT4TS(nn.Module):
    ...
    def __init__(self, configs, device):
        ...
        self.adapter_in_layer = nn.ModuleList([nn.Linear(configs.patch_size, configs.d_model) for i in range(configs.adapter_layer)])
    ...
    def forward(self, x, *args, **kwargs):
        ...
        # print("outputs.shape = {}, {}, {}, {}, {}".format(outputs.shape, B, M, self.d_ff, self.patch_num))
