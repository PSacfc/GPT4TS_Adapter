...
parser.add_argument('--C_type', type=int, default=0)
parser.add_argument('--scale', type=int, default=100)
parser.add_argument('--adapter_dim', type=int, default=32)
parser.add_argument('--adapter_layer', type=int, default=6)
parser.add_argument('--spect_adapter_layer', type=int, default=6)
