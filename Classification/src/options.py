...
class Options(object):
    ...
    def __init__(self):
        ...
        # GPT4TS
        self.parser.add_argument('--gpt_layers', type=int, default=6, help='gpt_layers')
        self.parser.add_argument('--adapter_layer', type=int, default=2, help='adapter_layer')
        self.parser.add_argument('--spect_adapter_layer', type=int, default=2, help='spect_adapter_layer')
        self.parser.add_argument('--T_type', type=int, default=1, help='T_type')
        self.parser.add_argument('--C_type', type=int, default=1, help='C_type')
        self.parser.add_argument('--adapter_dim', type=int, default=32, help='adapter_dim')
        self.parser.add_argument('--adapter_dropout', type=float, default=0.1, help='adapter dropout')
